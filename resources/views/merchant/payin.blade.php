...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Payin</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Payin</li>
                </ol>
            </div>
        </div>
    </div>
                                            ...
                                            @isset($transactions)
                                                @foreach ($transactions as $trx)
                                                    <tr>
                                                        ...
                                                        <td>₹{{ sprintf('%.2f', (float) $trx->amount - (float) ($trx->gst_inc_charge == 0 ? $trx->charge : $trx->gst_inc_charge)) }}
                                                        </td>
                                                        <td>
                                                            @php
                                                        ...
                                                        <td style="text-transform: capitalize;">{{ $trx->type == 'credit' ? 'Payin' : 'Payout' }}</td>
...
<script>
    $(document).ready(function () {
        ...
        $('#reportModal button.btn-primary').click(function () {
            ...
            // Grab header texts including the last column.
            ...
            if (downloadType === "Excel") {
                ...
                printWindow.document.write('<html><head><title>payin_report' + "{{ date('d-m-Y') }}" + '</title>');
                printWindow.document.write('<style>table { width: 100%; border-collapse: collapse; }');
                printWindow.document.write('table, th, td { border: 1px solid black; padding: 5px; text-align: left; }</style>');
