                                    ...
                                    @foreach ($beneficiaries as $bene)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- Delete Button -->
                                                <form action="{{ url('merchant/delete/beneficiary', $bene->id) }}"
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" method="POST" action="{{ url('merchant/add/beneficiary') }}">
            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $(".edit-btn").click(function() {
            ...
            $("#editBeneficiaryForm").attr("action", "/merchant/update/beneficiary/" + id);
        });
