...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">PayOut Reports (Merchants)</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">PayOut Reports (Merchants)</li>
                </ol>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#showTransBtn").click(function() {
            ...
            $.ajax({
                url: "{{ url('agent/fetch-transactions-payout') }}",
                type: "GET",
                data: {
                                    ...
                                    <td>
                                        ${
                                            (() => {
                                                let data;
                                                try {
                                                    data = JSON.parse(transaction.request_data);
                                                ...
                                                return transaction.acc_no ?? data?.payload?.account_number ?? "N/A";
                                            })()
                                        }
                                    </td>
                                    <td>
                                        ${
                                            (() => {
                                                ...
                                                return transaction.ifsc ?? data?.payload?.bank_ifsc ?? "N/A";
                                            })()
                                        }
                                    </td>
                                    <td>
                                        ${
                                            (() => {
                                                ...
                                                return transaction.beneficiary_name ?? data?.payload?.bene_name ?? "N/A";
                                            })()
                                        }
                                    </td>
