...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Merchant Profile</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">PayOut Profile</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input disabled readonly type="text" name="merchant_name" id="merchant_name" class="form-control" placeholder="Merchant Name"
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input disabled readonly type="text" name="merchant_city" id="merchant_city" class="form-control" placeholder="Merchant City" value="{{ $merchant->merchant_city }}">
                            <label for="merchant_city">Merchant City <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input disabled readonly type="text" name="merchant_state" id="merchant_state" class="form-control" placeholder="Merchant State" value="{{ $merchant->merchant_state }}">
                            <label for="merchant_state">Merchant State <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input disabled readonly type="text" name="merchant_country" id="merchant_country" class="form-control" placeholder="Merchant Country" value="{{ !$merchant->merchant_country ? "India" : $merchant->merchant_country }}">
                            <label for="merchant_country">Merchant Country <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <input disabled readonly type="text" name="merchant_zip" id="merchant_zip" class="form-control" placeholder="Merchant Zip Code" value="{{ $merchant->merchant_zip }}">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <select disabled readonly name="merchant_is_onboarded" id="merchant_is_onboarded" class="form-control" aria-placeholder="Merchant Onboarding Completed">
                    ...
                    {{-- <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <select disabled readonly name="merchant_is_verified" id="merchant_is_verified" class="form-control" aria-placeholder="Merchant Approval">
                                <option value="">Select</option>
                    ...
                    <div class="col-md-8 mb-3">
                        <div class="form-floating">
                            <input disabled readonly type="text" name="merchant_landmark" id="merchant_landmark" class="form-control" placeholder="Merchant Landmark" value="{{ $merchant->merchant_landmark }}">
                            <label for="merchant_landmark">Merchant Landmark <span class="text-danger">*</span></label>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="form-floating">
                            <select disabled readonly name="merchant_status" id="merchant_status" class="form-control" aria-placeholder="Merchant Status">
                                <option value="">Select</option>
                    ...
                    {{-- <div class="col-md-12 text-end">
                        <input disabled readonly type="submit" value="Update" class="btn btn-primary">
                    </div> --}}
                </div>
            </div>
        </div>
                ...
                <h2>Business Info</h2>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input disabled readonly type="text" name="business_name" id="business_name" class="form-control" placeholder="Business Name"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select disabled readonly name="business_type" id="business_type" class="form-control" aria-placeholder="Business Type">
                                    <option value="">Select</option>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea disabled readonly class="form-control" name="business_address" id="business_address" cols="30" rows="5" placeholder="Business Address">{{ $business->business_address }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="form-floating">
                                <input disabled readonly type="text" name="business_website" id="business_website" class="form-control" placeholder="Bisiness Website"
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select disabled readonly name="business_is_verified" id="business_is_verified" class="form-control" aria-placeholder="Business Verification">
                                    <option value="">Select</option>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <select disabled readonly name="business_status" id="business_status" class="form-control" aria-placeholder="Business Status">
                                    <option value="">Select</option>
